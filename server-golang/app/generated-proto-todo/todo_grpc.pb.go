...
type TodoServiceClient interface {
	...
	CreateString(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error)
...
func (c *todoServiceClient) CreateString(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error) {
	out := new(StringMessage)
	err := c.cc.Invoke(ctx, "/todo.v2.TodoService/CreateString", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TodoServiceServer interface {
	...
	CreateString(context.Context, *StringMessage) (*StringMessage, error)
...
func (UnimplementedTodoServiceServer) CreateString(context.Context, *StringMessage) (*StringMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateString not implemented")
}
...
func _TodoService_CreateString_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StringMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TodoServiceServer).CreateString(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.v2.TodoService/CreateString",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServiceServer).CreateString(ctx, req.(*StringMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TodoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateString",
			Handler:    _TodoService_CreateString_Handler,
		},
		{
			MethodName: "GetTodo",
